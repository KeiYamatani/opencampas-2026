      ...
      {phase === "intro" && (
        <section className="intro">
          ...
          <div className="taskPicker">
            ...
            <article>
              <span className="taskLabel"><b>課題2</b><i>連続比較</i></span><h2>今回の刺激は、前より長い？</h2><p>0.2、0.4、0.8、1.6秒の刺激が連続して現れます。直前の刺激と比べ、今回が長いか短いかを毎回選びます。</p>
              <div className="taskMiniRules"><b>2倍</b><i>／</i><b>4倍</b><i>／</i><b>8倍</b></div>
              <a className="start taskStartLink" href={SERIAL_COMPARISON_HREF}>この課題をはじめる <span>→</span></a>
            </article>
          </div>
